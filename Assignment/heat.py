...
if __name__ == "__main__":
    ...
    if HOST != None:
        client.Client(7777, "HEAT", "MANA", mana, v, HOST).start()
        client.Client(8888, "HEAT", "ENVI", envi, v, HOST).start()
    else:
        client.Client(7777, "HEAT", "MANA", mana, v).start()
        client.Client(8888, "HEAT", "ENVI", envi, v).start()
